...
public class p2p_student_info {
    ...
    public Long getCollegesId() {
        return collegesId;
    }

    public void setCollegesId(Long collegesId) {
        this.collegesId = collegesId;
    }

    public Long getRelativeStuId() {
        return relativeStuId;
    }

    public void setRelativeStuId(Long relativeStuId) {
        this.relativeStuId = relativeStuId;
    }
